...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http)throws Exception {
		...
		.permitAll()
		.antMatchers(HttpMethod.POST,SecurityConstant.ADMIN_ADD_CREATE)
		.permitAll()
		.antMatchers(HttpMethod.POST,SecurityConstant.ADMIN_SUB_CREATE)
		.permitAll()
		.antMatchers(HttpMethod.POST,SecurityConstant.ADMIN_MUL_CREATE)
		.permitAll()
		.antMatchers(HttpMethod.POST,SecurityConstant.ADMIN_MIX_CREATE)
